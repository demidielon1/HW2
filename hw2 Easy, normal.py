...
fruits1 = ["яблоко", "банан", "киви", "арбуз", "ананас", "апельсин", "вишня", "груша", "лимон"]
fruits2 = ["апельсин", "вишня", "груша", "лимон"]

print('Первый список: {}'.format(fruits1))
print('нужно удалить: {}'.format(fruits2))
for fr in fruits1[:]:
     for bdfr in fruits2[:]:
         if bdfr == fr:
             fruits1.remove(bdfr)
print('Оставшиеся: {}'.format(fruits1))
...
for el in reversed(list1):
 count = list1.index(el)
 if (el % 2) == 0:
     new_el= el/4
     list2.insert(0, new_el)
     list1.remove(el)
